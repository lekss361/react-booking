  ...
  return (
    <div className="blocks">
        <div className="grid">
            ...
            <div className="right">
                <svg className="blur blur-3" xmlns="http://www.w3.org/2000/svg" width="520" height="678"
                    viewBox="0 0 520 678" fill="none">
                    ...
                    <defs>
                        <filter id="filter0_f_4_11" x="0" y="0" width="734" height="678" filterUnits="userSpaceOnUse"
                ...
                <svg className="blur blur-4" xmlns="http://www.w3.org/2000/svg" width="461" height="678"
                    viewBox="0 0 461 678" fill="none">
                    ...
                    <defs>
                        <filter id="filter0_f_4_13" x="0" y="0" width="734" height="678" filterUnits="userSpaceOnUse"
                            color-interpolation-filters="sRGB">
                            <feFlood flood-opacity="0" result="BackgroundImageFix" />
                            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                ...
                <img  className="home-6" src={home6}/>
                <img className="sofa" src={sofa}/>
                <img className="small-image vase" src={vase}/>
                <img className="small-image armchair" src={armchair}/>
                <svg className="play" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"
                    fill="none">
                    ...
                    <defs>
                        <filter id="filter0_b_4_203" x="-5" y="-5" width="58" height="58" filterUnits="userSpaceOnUse"
                            color-interpolation-filters="sRGB">
                            <feFlood flood-opacity="0" result="BackgroundImageFix" />
                            <feGaussianBlur in="BackgroundImageFix" stdDeviation="2.5" />
                            <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_4_203" />
                            <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_4_203"
                                result="shape" />
                        </filter>
